...
var style_total_by_landfill_confirmed_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value >= 1000.000000 && value <= 5000000.000000) {
        ...
        image: new ol.style.RegularShape({radius: 4.0 + size, points: 6,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(255,255,255,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.76}), fill: new ol.style.Fill({color: 'rgba(204,0,14,1.0)'})}),
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 15000000.000000 && value <= 30000000.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 30000000.000000 && value <= 65069851.000000) {
            style = [ new ol.style.Style({
